...
const FAUNA = [
  ...
  { id:'tucan-pico-iris',     comunEs:'Tuc&aacute;n pico iris',        comunEn:'Keel-billed Toucan',           cientifico:'Ramphastos sulfuratus',      img:'images/fauna/tucan-pico-iris.jpeg',            tipo:'ave',      tours:['day','private'],        destacada:true,  porConfirmar:false },
  { id:'colibri-gorgimorado', comunEs:'Colibr&iacute; monta&ntilde;&eacute;s gorgimorado', comunEn:'Purple-throated Mountain-gem', cientifico:'Lampornis calolaemus', img:'images/fauna/colibri-gorgimorado.jpeg', tipo:'ave', tours:['day','private'], destacada:true,  porConfirmar:false },
  { id:'soterrey-cucarachero',comunEs:'Soterrey cucarachero',          comunEn:'House Wren',                   cientifico:'Troglodytes aedon',          img:'images/fauna/soterrey-cucarachero.jpeg',       tipo:'ave',      tours:['day','private'],        destacada:false, porConfirmar:false },
  { id:'guatusa',             comunEs:'Guatusa',                       comunEn:'Central American Agouti',      cientifico:'Dasyprocta punctata',        img:'images/fauna/guatusa.jpeg',                    tipo:'mamifero', tours:['day','night','private'], destacada:false, porConfirmar:false }
